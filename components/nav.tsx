...
const navItems = [
  ...
  { href: "/actions", label: "Action Items", icon: "CheckCircle" },
  { href: "/search", label: "Search", icon: "Search" },
];

// Simple SVG icons to avoid adding lucide-react as a dependency
// (shadcn/ui already includes it, but keeping nav self-contained)
